...
export default class Button implements IScript<Props> {
  openClip = new AudioClip(
    'ed36149f-76c5-45c4-a678-d4b31c4ed9ca/sounds/open.mp3'
  )
  closeClip = new AudioClip(
    'ed36149f-76c5-45c4-a678-d4b31c4ed9ca/sounds/close.mp3'
  )
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(
      new GLTFShape(
        'ed36149f-76c5-45c4-a678-d4b31c4ed9ca/models/Door_Fantasy.glb'
      )
    )
